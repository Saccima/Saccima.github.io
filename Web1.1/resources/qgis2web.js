...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [5246969.137668, -2139798.224229, 5255565.213895, -2135321.964670], maxZoom: 28, minZoom: 14
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([5246969.137668, -2139798.224229, 5255565.213895, -2135321.964670], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Detection / Classification et Extraction des sites a fosses au Madagascar</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (97 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Projet du Cours "Advanced remote sensing and spatial modelling" Madagascar<br />Auteur : Sanley ACCIMA';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Lessitesafosses_D1_3,
    colName: 'id',
    zoom: 10,
    collapsed: true,
    map: map

...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [513084.413680, 5264529.902282, 893925.965446, 5473255.236807], maxZoom: 28, minZoom: 4
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([513084.413680, 5264529.902282, 893925.965446, 5473255.236807], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Spatialisation des incendies du departement VAR a l\'echelle des carreaux de DFCI</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (87 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Projet de Geovisualisation sur le  "Departement VAR (83)" FRANCE<br />Auteur : Sanley ACCIMA';
            }

...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [5271909.909458, -2157512.328223, 5276323.244009, -2155214.159798], maxZoom: 26, minZoom: 12
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([5271909.909458, -2157512.328223, 5276323.244009, -2155214.159798], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Detection / Classification et Extraction des sites a fosses au Madagascar par rapport au Relief</h2>';
        return titleElement;
    })(),
